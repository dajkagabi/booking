...
const apartmentsData = [
  ...
  },
  {
    ...
    description:
      "Spacious apartment with a private garden access, perfect for families.",
    image: t,
    guests: 4,
    size: "70 m²",
    view: "Garden view",
  ...
  },
  {
    ...
    description:
      "Exclusive penthouse with private rooftop pool and stunning panoramic views.",
    image: ap1,
    guests: 6,
    size: "120 m²",
    view: "Panoramic",
  ...
  },
  {
    ...
    description:
      "Small but comfortable studio apartment in the heart of the city.",
    image: c,
    guests: 1,
    size: "20 m²",
    view: "City view",
  ...
  },
  {
    ...
    description:
      "Contemporary apartment with stunning lake views, perfect for a peaceful getaway.",
    image: d,
    guests: 3,
    size: "55 m²",
    view: "Lake view",
  ...
  },
  {
    ...
    description:
      "Quaint studio located in the historic old town, steps away from attractions.",
    image: ch,
    guests: 2,
    size: "30 m²",
    view: "Street view",
  ...
  },
  {
    ...
    description:
      "Rustic yet luxurious chalet nestled in the mountains with breathtaking views.",
    image: w,
    guests: 5,
    size: "90 m²",
    view: "Mountain view",
  ...
  },
  {
    ...
    name: "Riverside Loft",
    description:
      "Stylish loft apartment overlooking the river, ideal for urban explorers.",
    image: rf,
    guests: 2,
    size: "60 m²",
    view: "River view",
    ...
    const applyFilters = () => {
      ...
      if (guests !== "" && guests !== "Any number of guests") {
        tempApartments = tempApartments.filter(
          (apartment) => apartment.guests >= parseInt(guests)
        );
      }
    ...
    <div className="min-h-screen bg-gray-900 text-white p-8">
      <div className="max-w-6xl mx-auto pt-24">
        ...
        <p className="text-center text-white mb-8">
          Discover our selection of premium accommodations, ranging from cozy
          studios to luxurious penthouses.
        </p>
        ...
        <div className="bg-gray-800 rounded-lg p-6 mb-8 shadow-lg">
          ...
          <div className="flex justify-between items-center mt-6 pt-4 border-t border-gray-700">
            <span className="text-white">
              Showing {filteredApartments.length} of {apartmentsData.length}{" "}
              accommodations
            </span>
            <button
                  ...
                  <div className="flex items-center text-gray-300 text-sm mb-4">
                    ...
                    <span className="flex items-center">
                      ...
                      >
                        <path
                          fillRule="evenodd"
                          d="M4 4a2 2 0 00-2 2v4a2 2 0 002 2V6h12v6a2 2 0 002-2V6a2 2 0 00-2-2H4zm12 14v-6a2 2 0 00-2-2H8a2 2 0 00-2 2v6H4v2h12v-2h-2z"
                          clipRule="evenodd"
                        ></path>
                      </svg>
                      {apartment.view}
