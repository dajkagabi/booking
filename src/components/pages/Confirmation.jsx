    ...
    <div className="p-4">
      ...
      <div className="bg-gray-700 p-6 rounded-lg shadow-md mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-300">
          ...
          <div>
            ...
            <p>
              Number of nights:{" "}
              <span className="font-semibold">{dates.nights} nights</span>
            </p>
            <p>
              Guests:{" "}
              <span className="font-semibold">
                {guests.numberOfAdults || 2} adults
              </span>
            </p>
          </div>
        </div>
      ...
      <div className="bg-gray-700 p-6 rounded-lg shadow-md mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-300">
          <div>
            <p>
              <span className="font-semibold">Name:</span> {guests.firstName}{" "}
              {guests.lastName}
            </p>
            <p>
              <span className="font-semibold">Email:</span> {guests.email}
            </p>
            <p>
              <span className="font-semibold">Phone:</span> {guests.phone}
            </p>
          </div>
          <div>
            <p>
              <span className="font-semibold">Address:</span> {guests.address}
            </p>
            <p>
              <span className="font-semibold">City:</span> {guests.city}
            </p>
            <p>
              <span className="font-semibold">Zip Code:</span> {guests.zipCode}
            </p>
            <p>
              <span className="font-semibold">Country:</span> {guests.country}
            </p>
          </div>
        </div>
      ...
      <div className="bg-gray-700 p-6 rounded-lg shadow-md mb-6">
        ...
        <div className="space-y-2 text-gray-300">
          <p className="flex justify-between">
            Base Price ({dates.nights} nights):{" "}
            <span>${priceSummary.basePrice}</span>
          </p>
          <p className="flex justify-between">
            Cleaning Fee: <span>${priceSummary.cleaningFee}</span>
          </p>
          <p className="flex justify-between">
            Service Fee: <span>${priceSummary.serviceFee}</span>
          </p>
          <p className="flex justify-between font-bold text-xl mt-4 text-white">
            Total: <span>${priceSummary.total}</span>
          </p>
        </div>
      </div>
